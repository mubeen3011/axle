...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <!-- <h3 class="panel-title" style="float: left;"> -->
           <span> <a aria-expanded="false" class="accordion" data-toggle="collapse" data-parent="#" href="javascript:void(0)">Zoho Account
                Info</a></span>
                <span><button style="float: right;" type="button" class="btn btn-primary">ZOHO VIEW</button></span>
        </h3>
